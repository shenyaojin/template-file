...
\begin{titlepage}
    ...
    \begin{center}
    \Large
            实验地点\ \ \underline{\makebox[220pt]{东四406}}\\
            \vspace{0.3cm}
            \quad\ 姓\; 名 \ \ \underline{\makebox[220pt]{金沈尧}}\\
            \vspace{0.3cm}
            \quad\ 学\; 号\ \ \underline{\makebox[220pt]{310100529}}\\
            \vspace{0.3cm}
            实验日期\ \ \underline{\makebox[220pt]{2021年 9 月 18 日}}\\
            \vspace{0.3cm}
            指导老师\ \ \underline{\makebox[220pt]{金沈尧}}\\
            \vspace{0.3cm}
